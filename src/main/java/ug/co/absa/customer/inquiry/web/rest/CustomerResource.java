...
import ug.co.absa.customer.inquiry.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link ug.co.absa.customer.inquiry.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CustomerResource {
    ...
    private static final String ENTITY_NAME = "ugdtAccountInquirySrvCustomer";
    ...
    public ResponseEntity<Customer> partialUpdateCustomer(
        ...
        Optional<Customer> result = customerRepository
            ...
            .map(existingCustomer -> {
                ...
                if (customer.getCustomerStatusCode() != null) {
                    existingCustomer.setCustomerStatusCode(customer.getCustomerStatusCode());
                }
                if (customer.getFreeField1() != null) {
                    existingCustomer.setFreeField1(customer.getFreeField1());
                }
                if (customer.getFreeField2() != null) {
                    existingCustomer.setFreeField2(customer.getFreeField2());
                }
                if (customer.getFreeField3() != null) {
                    existingCustomer.setFreeField3(customer.getFreeField3());
                }
                if (customer.getFreeField4() != null) {
                    existingCustomer.setFreeField4(customer.getFreeField4());
                }
                if (customer.getFreeField5() != null) {
                    existingCustomer.setFreeField5(customer.getFreeField5());
                }
                if (customer.getFreeField6() != null) {
                    existingCustomer.setFreeField6(customer.getFreeField6());
                }
                if (customer.getFreeField7() != null) {
                    existingCustomer.setFreeField7(customer.getFreeField7());
                }
                if (customer.getFreeField8() != null) {
                    existingCustomer.setFreeField8(customer.getFreeField8());
                }
